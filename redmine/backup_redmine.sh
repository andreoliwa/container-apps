...
$HOME_DIR/.local/bin/docker-compose -f $HOME_DIR/container-apps/postgres/docker-compose.yml exec -T postgres12 pg_dump -U postgres redmine > $HOME_DIR/OneDrive/Backup/redmine_$(date "+%Y-%m-%d-%H-%M-%S").sql
